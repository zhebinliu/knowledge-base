...
export default function CitedReportView({ content, provenance, onCitationClick }: Props) {
  return (
    <div className="prose prose-sm max-w-none prose-headings:font-bold prose-h1:text-2xl prose-h2:text-lg prose-h2:mt-8 prose-h2:mb-3 prose-h3:text-base prose-table:text-xs">
      <ReactMarkdown
