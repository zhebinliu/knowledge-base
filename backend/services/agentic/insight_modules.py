...
【术语统一(强制中文)】
- Owner / owner → 责任人
- Deadline / deadline / due → 截止日期
- Next Step / Next steps → 下一步
- Action Item → 行动项
- Risk → 风险 / Issue → 问题
- 不要在正文/表格/bullet 里直接出现上面这些英文标签(MBB 行话除外:RAG/SCQA/SaaS/CRM/ERP 这类专有缩写可保留)

【禁止】
- 禁止输出 H1 / H2 章节标题(系统会自动注入)
- 禁止 emoji
- 禁止"我们认为/相信/坚信",克制,克制,再克制
- **禁止前导句 / 元描述** — 不要写"根据上传文档(D1-D8)和知识库(K1-K5),以下是 N 条..."
  这种把上下文复述一遍的开场白,直接进入正文(列表 / 表格 / 段落第一项),
  系统已经自动注入章节标题,你的输出从内容第一行开始
- 禁止"以下是..."/"我将..."/"请允许我..."/"接下来..."等过渡句,直接出干货"""
...
- **下一步(Next Step)**: 每条配 责任人 + 截止日期(不是"加强沟通")
...
- **R(Risks)**: 风险 / 影响 / 可能性 / 应对 / 责任人
- **A(Actions)**: 待执行动作 / 责任人 / 截止日期 / 状态
- **I(Issues)**: 已发生的问题 / 影响 / 阻塞 / 责任人 / 解决路径
...
""" + COMMON_STYLE,
    ...
    ModuleSpec(
        ...
        title="下一步建议",
        necessity="critical",
        purpose="分级建议:本周 / 本月 / 季度,每条 责任人 + 截止日期 + 预期产出",
        fields=[
...
- 截止日期用绝对日期 + 周次(如 `2025-09-05 (W36)`),不用相对表述
