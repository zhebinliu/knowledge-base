...
| 方法 | 适用场景 | 持续时长 | 备注 |
   ...
   **持续时长基准**(严格): 高管 1on1 45-60min / 集中访谈 60-90min / 工作坊 60-90min / 现场观察 ≤90min / 资料收集 贯穿;**单场上限 90min**
2. **总周期与节奏**: 总周期 N 周;每周 X 场;典型一天密度 Y 场;**同一客户人员单周被访 ≤ 2 场,高管 ≤ 1 场**
...
【时长约束 — 严格遵守,客户配合度的核心保障】
- **每场默认 60 分钟**,议题深度足够的可 90 分钟,**不超过 90 分钟**
- 高管 / 1on1:45-60 分钟(高管时间最紧,坚决不超 1 小时)
- 集中访谈 / 部门座谈:60-90 分钟
- 工作坊 / 现场观察:90 分钟为限,超 90 分钟必须拆成 2 场不同主题
- 禁止出现 "2h / 3h / 半天 / 全天" — 即使行业包样本里写了,也要按本约束压缩
- 资料收集 / 文档审阅 走"贯穿"非访谈场次,不计入时长

【合并约束 — 效率优先,减少客户疲劳】
- **同一拨人不在同一周内被反复叫**:相同部门 + 相近层级的人员尽量合并到同一场,议题打包
  例: 销售总监 + 销售运营经理 合并一场(60-90min)谈"L2C 全流程现状", 而不是分两场
  例: 一线销售 3-5 人 一场座谈, 而不是每人单独访谈
- 跨部门但议题相关的工作坊式 1 场覆盖(例: IT + 业务 + 集成 工作坊)
- 高管 1on1 单独成场 (高管不和部门负责人混场)
- **每个客户参与人 1-2 周内被叫的总场次 ≤ 2 场**(高管 ≤ 1 场)

【场次规模】
- 总场次精简为 **6-10 场**(优先合并,不堆场次)
- 工作坊 / 现场观察 这类非访谈场次也要纳入(标议题)
- 不要把访谈+材料收集合并成一行 — 分开行(材料收集走"贯穿"行)
