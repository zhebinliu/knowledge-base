    ...
    ModuleSpec(
        ...
        fields=[
            FieldSpec("discovery_objective", "调研目的", "text",
                      ...
                      user_question="本轮调研的核心目的是什么?(摸底现状 / 验证方案 / 收集需求 / 确认变更)",
                      required=True),
            ...
            FieldSpec("expected_decisions", "调研后要拍板的事项", "list",
                      ["brief", "conversation"], "ask_user",
                      user_question="这一轮调研结束后,需要拍板哪些事项?(范围 / 优先级 / 阶段切分)"),
        ],
    ...
    ModuleSpec(
        ...
        fields=[
            ...
            FieldSpec("duration_weeks", "总周期", "text",
                      ["brief", "conversation"], "ask_user",
                      user_question="本轮调研总周期是几周?(2 / 3 / 4 周)",
                      required=True),
...
| 类别 | 具体材料 | 涉及部门 | 用于哪场访谈 | Owner | 截止日 |

类别建议: 组织 / 业务流程 / 数据 / 系统 / 制度 / 战略

【约束】
- 截止日按 Week 表示(例: Week 1 周一前 / Week 2 周二前)
- Owner 写部门或角色,不写具体人(具体人在 brief 里)
