...
class QualityReport(Base):
    ...
    verdict: Mapped[str] = mapped_column(String(32), nullable=False)  # excellent / good / pass / needs_work / fail
    dimensions: Mapped[dict] = mapped_column(JSON, nullable=False)  # {format: {score, comments}, ...}
